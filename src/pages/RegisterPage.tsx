      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Input label="Ім'я користувача" placeholder="username" error={errors.username?.message} {...register('username')} />
            <Input label="Пароль" type="password" placeholder="••••••••" error={errors.password?.message} {...register('password')} />
            <Input label="Підтвердити пароль" type="password" placeholder="••••••••" error={errors.confirmPassword?.message} {...register('confirmPassword')} />
